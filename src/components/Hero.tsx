...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden deep-forest-bg">
      {/* Decorative elements */}
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
            Hello, I'm
            <span className="block bg-gradient-to-r from-emerald-medium to-emerald-light bg-clip-text text-transparent">Chad Mortensen</span>
          </h1>
        ...
        <button 
          onClick={scrollToAbout} 
          className="animate-bounce text-cream hover:text-emerald-light transition-colors duration-200"
        >
          <ArrowDown size={32} />
        </button>
      </div>
