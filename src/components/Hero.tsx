...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden mountain-bg">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <TreePine className="absolute bottom-60 right-1/3 text-forest-dark" size={24} style={{
        animationDelay: '1s'
      }} />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-mist mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-md">I’m a product design leader with 25+ years of experience turning complex problems into meaningful outcomes — by guiding teams, shaping culture, and building thoughtful, scalable design solutions across eCommerce, health tech, and omnichannel platforms.
</p>
        ...
        <button onClick={scrollToAbout} className="animate-bounce text-mist hover:text-sage transition-colors duration-200">
          <ArrowDown size={32} />
        </button>
      </div>
    </section>;
